################################################################################
# strava - strava API wrapped in Python3

#  Copyright 2020 Guanyu Wang
################################################################################
...
def process_activity(activity, unit="mi"):
    ...
    if unit == "km":
        ...
        activity["distance"] = activity["distance"] / METERS_PER_MI
...
class Strava:
  ...
  """
    ...
    def listAthleteActivities(
        self, access_token, before=None, after=None, page=None, per_page=None
    ):
        """
